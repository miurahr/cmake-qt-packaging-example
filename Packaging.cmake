...
function(macdeployqt bundle targetdir generators)
    file(GENERATE OUTPUT ${CMAKE_BINARY_DIR}/CPackMacDeployQt.cmake
      CONTENT "foreach(_PACKAGER ${generators})
                 execute_process(COMMAND ls -lR \"${CPACK_PACKAGE_DIRECTORY}/_CPack_Packages/Darwin/${_PACKAGER}/\")
                 execute_process(COMMAND \"${MACDEPLOYQT_EXECUTABLE}\" \"${CPACK_PACKAGE_DIRECTORY}/_CPack_Packages/Darwin/${_PACKAGER}/${targetdir}/${bundle}\" -always-overwrite)
               endforeach()
               ")
...
elseif(APPLE)
    ...
    macdeployqt("${PROJECT_NAME}.app" "${PROJECT_NAME}-${PROJECT_VERSION}-Darwin" "${CPACK_GENERATOR}")
